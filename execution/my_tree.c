...
void	one_cmd(t_tree **tree)
{
	...
	(*tree)->cmd_line = malloc(sizeof(t_cmd_element));
	(*tree)->cmd_line->content = ft_strdup("ssssss");
	(*tree)->cmd_line->quoted = 0;
	(*tree)->cmd_line->next = malloc(sizeof(t_cmd_element));
	(*tree)->cmd_line->next->content = ft_strdup("ROSE=Hello");
...
void and_two_cmd(t_tree **tree)
{
	...
	(*tree)->left->content = ft_strdup("echo ROSE");
	...
	(*tree)->left->cmd_line->next->content = ft_strdup("ROSE=hello");
	(*tree)->left->cmd_line->next->next = NULL;
	(*tree)->left->left = NULL;
	(*tree)->left->right = NULL;
	(*tree)->left->files = NULL;
	(*tree)->right = malloc(sizeof(t_tree));
...
void	pipe_simple_input(t_tree **tree)
{
	...
	(*tree)->right = malloc(sizeof(t_tree));
	(*tree)->right->type = CMD_LINE;
	(*tree)->right->content = ft_strdup("catsss");
	(*tree)->right->cmd_line = malloc(sizeof(t_cmd_element));
	(*tree)->right->cmd_line->content = ft_strdup("catssss");
	// (*tree)->right->cmd_line->quoted = 0;
...
void	complex_pipe_input(t_tree **tree)
{
	...
	(*tree)->left->files = NULL;
	(*tree)->left->left = malloc(sizeof(t_tree));
	...
	(*tree)->left->right = malloc(sizeof(t_tree));
...
// 	t_tree *echo_rev_pipe = (*tree)->left;

// 	echo_rev_pipe->left = malloc(sizeof(t_tree));
...
// 	// echo "hello"
// 	echo_rev_pipe->left->left = malloc(sizeof(t_tree));
...
// 	// rev (1st)
// 	echo_rev_pipe->left->right = malloc(sizeof(t_tree));
...
// 	// cat -e
// 	echo_rev_pipe->right = malloc(sizeof(t_tree));
...
void	quadruple_pipes_input(t_tree **tree)
{
	*tree = malloc(sizeof(t_tree));
	...
	(*tree)->left->left->right = malloc(sizeof(t_tree));
	...
	// Left-Left-Left: rev
	(*tree)->left->left->left = malloc(sizeof(t_tree));
	...
	(*tree)->left->left->left->right = malloc(sizeof(t_tree));
	...
	(*tree)->left->left->left->left = malloc(sizeof(t_tree));
